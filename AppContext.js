...
export function AppProvider({children}) {
    // [source, title, decription, url, imageUrl, publishedAt, content]
  const [news, setNews] = useState([
    {source : "", title : "TEST_1", description : "", url : "", imageUrl : "", publishedAt : "", content : ""},
    {source : "", title : "TEST_2", description : "", url : "", imageUrl : "", publishedAt : "", content : ""},
    {source : "", title : "TEST_3", description : "", url : "", imageUrl : "", publishedAt : "", content : ""},
    {source : "Izhlife.ru",title : "Борьба продолжается: Дуров разоблачил Болгар", description:"Как сообщает StarHit, представитель Дурова дал комментарий зарубежным СМИ о его отношениях с Болгар. Мы уже писали, кто такая Ирина и как раскрылись измены Дурова.",
